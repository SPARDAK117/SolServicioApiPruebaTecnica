...
namespace ServicioApiPruebaTecnica.Migrations
{
    ...
    [Migration("20240902190346_AddLogEntriesTable")]
            ...
            modelBuilder.Entity("ServicioApiPruebaTecnica.Data.Producto", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SKU = "A123",
                            created_at = new DateTime(2024, 9, 2, 13, 3, 45, 455, DateTimeKind.Local).AddTicks(5853),
                        ...
                        new
                        {
                            ...
                            SKU = "B456",
                            created_at = new DateTime(2024, 9, 2, 13, 3, 45, 455, DateTimeKind.Local).AddTicks(5860),
                            deleted_at = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            updated_at = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            SKU = "C789",
                            created_at = new DateTime(2024, 9, 2, 13, 3, 45, 455, DateTimeKind.Local).AddTicks(5862),
                            deleted_at = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            updated_at = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("ServicioApiPruebaTecnica.Data.Sucursal", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            SucursalName = "Xola",
                            Telefono = "5546354636",
                            created_at = new DateTime(2024, 9, 2, 13, 3, 45, 455, DateTimeKind.Local).AddTicks(4796),
                            updated_at = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ...
                            Telefono = "5532165487",
                            created_at = new DateTime(2024, 9, 2, 13, 3, 45, 455, DateTimeKind.Local).AddTicks(4813),
                            updated_at = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
